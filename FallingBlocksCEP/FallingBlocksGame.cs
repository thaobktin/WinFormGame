...
namespace FallingBlocksCEP
{
    class FallingBlocksGame
    {
        ...
        public const int ColumnWidth = 30;  // also known as CellWidth
        public const int ColumnHeight = 30; // also known as CellHeight
        public const int NumCols = 10;
        public const int NumRows = 22;
        ...
        public void DropRows(List<int> rowsToDrop)
        {
            ...
            {
                updateScore(400); // not sure if this is actual FallingBlocks scoring method for 4 line clear
            }
